        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(this.form.post('/login', this.form));
      ...
      _c("div", { staticClass: "card" }, [
        _c("div", { staticClass: "card-body login-card-body" }, [
          _c("p", { staticClass: "login-box-msg" }, [
            _vm._v(_vm._s(_vm.$t("login-view.title")))
          ]),
          _vm._v(" "),
          _c("form", [
            _c(
              ...
              [
                _c("input", {
                  ...
                  attrs: {
                    type: "email",
                    placeholder: _vm.$t("login-view.email")
                  },
            ...
            _c(
              ...
              [
                _c("input", {
                  ...
                  attrs: {
                    type: "password",
                    placeholder: _vm.$t("login-view.password")
                  },
            ...
            _c("div", { staticClass: "row" }, [
              ...
              _c("div", { staticClass: "col-6" }, [
                _c(
                  ...
                  [_vm._v(_vm._s(_vm.$t("login-view.login")))]
                )
              ])
            ])
          ]),
